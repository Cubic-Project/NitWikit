...
![](_assets/Linux开服/数据库安装/5.png)

至此安装完成，输入 `redis-cli` 即可进入命令行管理

![](_assets/Linux开服/数据库安装/6.png)

:::tip

使用 `systemctl enable redis-server` 使 Redis 开机自启

![](_assets/Linux开服/数据库安装/7.png)

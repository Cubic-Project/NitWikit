...
<Tabs>
    ...
    <TabItem label="RedHat/CentOS">sudo yum install java-11-openjdk</TabItem>
    <TabItem label="ArchLinux">sudo pacman -S jdk11-openjdk</TabItem>
</Tabs>
...
<Tabs>
    ...
    <TabItem label="RedHat/CentOS">update-alternatives --config java</TabItem>
    <TabItem label="ArchLinux">archlinux-java set jdk-vesion</TabItem>
</Tabs>

...
![](_assets/历史版本-bukkit-1.png)

点击左侧文字可以查看详细内容：

![](_assets/历史版本-bukkit-2.png)

这里是更新日志：

![](_assets/历史版本-bukkit-3.png)

</TabItem>

<TabItem value="spigotmc" label="SpigotMC">

![](_assets/历史版本-spigotmc.png)

</TabItem>

<TabItem value="modrinth" label="Modrinth">

![](_assets/历史版本-modrinth.png)
...
![](_assets/历史版本-GitHub-1.png)

或者这样子：

![](_assets/历史版本-GitHub-2.png)

![](_assets/历史版本-GitHub-3.png)

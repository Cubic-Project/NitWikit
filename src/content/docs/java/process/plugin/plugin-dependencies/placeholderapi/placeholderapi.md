...
## ![介绍](_assets/PlaceHolderAPI/6.png)
...
## ![安装](_assets/PlaceHolderAPI/7.png)

![](_assets/PlaceHolderAPI/8.png)

## ![在其他插件使用](_assets/PlaceHolderAPI/9.png)
...
## ![配置文件](_assets/PlaceHolderAPI/10.png)
...
## ![插件命令](_assets/PlaceHolderAPI/12.png)

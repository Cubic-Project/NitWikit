...
Folia：
- [官方](https://papermc.io/downloads/folia)
- [McRes](https://mcres.cn/downloads/folia.html)

Luminol:
- [McRes](https://mcres.cn/downloads/luminol.html)
...
- [McRes](https://mcres.cn/sites/637.html/)
...
- [McRes](https://mcres.cn/sites/649.html/)
...
- [McRes](https://mcres.cn/sites/709.html/)
...
| 名称                                                      | 介绍                                       |
| --------------------------------------------------------- | ------------------------------------------ |
| [CraftBukkit](https://getbukkit.org/download/craftbukkit) | 由 Bukkit 团队制作的较为古早的基座核心，几乎无优化 |

...
3. 对单个服务器，在内存有一点点富裕的情况下 (通常不到 1 GB)，仍推荐使用跨服端，服务端对于反假人攻击的性能不如代理端，如果你被攻击了，更换成跨服端再说;
...
对于各个 MC 服务器**部署在不同的服务器**上，跨服代理和子服之间出现了没法进行稳定连接的情况时，也可以尝试原版 1.20.5 服务器新增的 [Transfer](./build-up/Transfer/transfer.md) 指令。
